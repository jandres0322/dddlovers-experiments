...
async def app_startup():
    global tasks
    global eventos
    task1 = asyncio.ensure_future(suscribirse_a_topico("eventos-solicitud-descarga-creada", "saludtech-bff", "public/default/eventos-solicitud-descarga-creada", eventos=eventos))
    tasks.append(task1)
